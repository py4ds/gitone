...
htmlhelp_basename: str = 'gitonedoc'
...
latex_documents: List[str] = [
    (master_doc, 'gitone.tex', 'Gitone Documentation',
...
man_pages: List[str] = [
    (master_doc, 'gitone', 'Gitone Documentation',
     ['Martin Skarzynski'], 1)
]
...
texinfo_documents: List[str] = [
    (master_doc, 'gitone', 'Gitone Documentation', 'Martin Skarzynski',
     'Gitone', 'Create, run, and convert Jupyter notebooks programmatically.',
     'Miscellaneous'),
]
